...
export class ThemeConflictService {
  private primaryColors = ['#60b4da', '#ed96f7', '#3f7eca', '#7c51eb', '#428376', '#826F5D', '#C6C6C6', '#d2b3f9','#000000'];
  private secondaryColors = ['#314560', '#b360f3', '#1b83eb', '#483469', '#487149', '#a88e75', '#DDE1E9', '#BB86FC','#ffffff'];
  private textColors = ['#E4F2FD', '#06bbd2', '#7aa0ca', '#522fa4', '#5d985f', '#f3dbc2', '#5F7285', '#EDEDED','#ffffff'];
  private backgroundColors = ['#266789', '#e4f2fd', '#c5effc', '#EEE8F6', '#f1f7e9', '#121212', '#EBECF0', '#121212','#000000'];
